                ...
                stage('E2E') {
                    ...
                    post {
                        always {
                            ...
                            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, icon: '', keepAll: false, reportDir: 'playwright-directory', reportFiles: 'index.html', reportName: 'Playwright local', reportTitles: '', useWrapperFileDirectly: true]
                        }
                    }
                } 
        ...
        stage('Prod E2E') {
            ...
            steps {
                sh '''
                    ...
                    node_modules/.bin/serve -s build &
                    sleep 10
                    npx playwright test -g "/Learn Jenkins/"  --reporter=html
                '''
            }
